<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="respuestaEjercicios.aspx.cs" Inherits="Fante.respuestaEjercicios" %>
...
<head runat="server">
    ...
    <link href="css/respuestaEjercicios.css" rel="stylesheet" />
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-10 informacion">
                    ...
                    <h3 class="visible-md visible-lg" style="margin-top: 10px;"><a href="indexlogueado.aspx" title="volver" style="color: white;"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span></a>&nbsp;&nbsp;&nbsp;Solución de Ejercicios</h3>
                    
                    <h4 class="visible-xs visible-sm" style="margin-top: 12px;"><a href="indexlogueado.aspx" title="volver" style="color: white;"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span></a>&nbsp;&nbsp;&nbsp;Solución de Ejercicios</h4>
                ...
                <div class="col-xs-12 col-sm-10 panelGris">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <asp:GridView ID="GridView_Ejercicios" runat="server" OnSelectedIndexChanged="Identificador_Ejercicios" DataKeyNames="id_Respuesta" AutoGenerateColumns="False" CellPadding="4" GridLines="None" Width="100%" ForeColor="#333333">
