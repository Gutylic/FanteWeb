<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modificarCelular.aspx.cs" Inherits="Fante.modificarCelular" %>
...
<head runat="server">
    ...
    <link href="css/modificarCelular.css" rel="stylesheet" />
            ...
            <div class="row">
                ...
                <div class="visible-sm visible-md visible-lg col-sm-2 panel panel-default panelBlanco">
                    ...
                    <div class="panel-body">
                        ...
                        <h4 style="color: gray; padding-top: 150px; font-size: 17px;">Modificar Celular</h4>
                                ...
                                <tr>
                                    ...
                                    <td class="well">
                                        ...
                                        <div class="col-xs-4 col-sm-2">
                                            ...
                                            <asp:TextBox ID="textBoxNumeroPais" Height="40px" Width="100%" runat="server" CssClass="form-control"></asp:TextBox>

                                        </div>

                                        <div class="col-xs-8 col-sm-10">

                                            <asp:TextBox ID="textBoxNumeroWhatsapp" Height="40px" Width="100%" CssClass="form-control" runat="server"></asp:TextBox>
