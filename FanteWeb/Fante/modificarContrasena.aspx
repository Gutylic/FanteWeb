<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modificarContrasena.aspx.cs" Inherits="Fante.modificarContrasena" %>
...
<head runat="server">
    ...
    <link href="css/modificarContrasena.css" rel="stylesheet" />
            ...
            <div class="row">
                ...
                <div class="visible-sm visible-md visible-lg col-sm-2 panel panel-default panelBlanco">
                    ...
                    <div class="panel-body">
                        ...
                        <h4 style="color: gray; padding-top: 150px; font-size: 17px;">Modificar Contraseña</h4>
                            ...
                            <table style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td class="well">
                                        ...
                                        <asp:Label ID="contrasenaPanel" runat="server" Text="Contraseña"></asp:Label>
                                ...
                                <tr>
                                    ...
                                    <td class="well">
                                        ...
                                        <asp:Label runat="server" ID="etiquetaErronea" Visible="false" ForeColor="Red" Font-Size="13px">La contraseña debe tener más de 6 caracteres</asp:Label>
                                        ...
                                        <asp:TextBox ID="textBoxContrasena" Height="40px" Width="100%" CssClass="form-control" runat="server"></asp:TextBox>
